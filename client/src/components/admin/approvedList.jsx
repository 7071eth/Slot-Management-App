        ...
        <tbody>
           {
            tabledata.slice(0).reverse().map((val, key) => {    
                ...
                {val.seat? <td class="px-6 py-4">
                {val.seat}
                </td> : <td class="px-6 py-4"><button onClick={()=>{
                    setModal(true);
                }} className='mr-3 
                     bg-blue-400 p-1 px-3 rounded-lg text-black'>Assign</button></td>}
                <td class="px-6 py-4 text-right">
                    ...
                    <button onClick={()=>{
                     ...
                     bg-red-400 p-1 px-3 rounded-lg text-black'>Move to rejected</button>
